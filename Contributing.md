SpecFlow is open source, meaning you can help the community in improving SpecFlow by contributing fixes and new features. If you feel you can contribute to SpecFlow's development, a good place to start is to check out the [[To-Do list |https://github.com/techtalk/SpecFlow/wiki/v2-TODO]] for open tasks and follow the discussions on the <a href="https://groups.google.com/forum/?_escaped_fragment]]_=topic/specflow/#!forum/specflow">forum</a>. Remember that you need to be willing to invest your own blood, sweat and tears into writing code, as the list of pending features is long and development resources are limited.
