...
* In your solution add a "Silverlight Unit Test Application" project. This adds a Silverlight Application project with the tests and a web project to the solution. The latter hosts the SL application to execute it in the browser.
